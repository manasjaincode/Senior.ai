...
const MainScreen = () => {
  ...
  return (
    <div 
      className="min-h-screen flex flex-col font-sans text-gray-100 relative overflow-hidden bg-gradient-to-br from-slate-900 to-slate-800"
      style={{
    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center justify-center flex-grow p-8 text-center md:text-left gap-8">
      ...
      <footer className="w-full text-center py-4 px-2 text-gray-400 text-sm bg-slate-900 bg-opacity-70">
