...
import dataset from './Dataset.json'; // ⬅️ STEP 1: Import the JSON file
...
// ⬅️ STEP 2: Pass the imported dataset as context/system instruction to the hook.
// This assumes useGeminiChat accepts a 'systemInstruction' or 'context' parameter.
const systemInstruction = `You are a helpful and experienced AI College Senior. Your primary goal is to provide guidance, tips, and accurate information based on the following specific college context (Dataset.json):\n\n${JSON.stringify(dataset, null, 2)}`;
const { messages, sendMessage, isLoading } = useGeminiChat(systemInstruction); 
